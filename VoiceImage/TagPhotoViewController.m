...
//        [array addObject:self.imageName];
//        NSArray* arr = [[NSArray alloc] initWithArray:array];
//        [HttpHelper uploadPhoto:self withSelector:@selector(uploadResponse:) imageName:arr imageData:self.data voicePath:[url path] date:[NSDate date] location: [NSString stringWithFormat:@"%@:%@:%@:%@", country,city, street, name]];
//    }
...
- (IBAction)skipClicked:(UIButton *)sender {
    ...
    NSArray* arr = [[NSArray alloc] initWithArray:array];
    self.view.userInteractionEnabled = NO;
    [HttpHelper uploadPhoto:self withSelector:@selector(uploadResponse:) imageName:arr imageData:self.data voicePath:nil date:[NSDate date] location: [NSString stringWithFormat:@"%@:%@:%@:%@",country,city,street,name]];
}
